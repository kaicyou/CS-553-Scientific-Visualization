...
const char *WINDOWTITLE = { "Project #7 - Haoxiang Wang" };
...
Display( void )
{
	...
	glLoadIdentity( );
	glColor3f( 1., 1., 1. );
	DoRasterString( 5., 5., 0., "Project #7" );
...
InitGlui( void )
{
	...
	Glui->add_checkbox("High Definition", &TintersectionsOn);
	...
	spinner = Glui->add_spinner("K Value", GLUI_SPINNER_FLOAT, &KValue, 0, (GLUI_Update_CB)SetKValue);
	       	spinner->set_float_limits( 5., 50. );
